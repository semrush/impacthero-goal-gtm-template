...
{
  "type": "TAG",
  "id": "impacthero-tracking-goal-gtm-template",
  "version": 1,
  "securityGroups": [],
  "displayName": "ImpactHero Conversion Tag",
  "categories": [
    "ANALYTICS",
    "ATTRIBUTION",
    "CONVERSIONS"
  ...
  "description": "Additional tag for ImpactHero. Fire this tag to record lead conversion event. Optionally add conversion name and cost.",
  "containerContexts": [
    "WEB"
  ]
}
...
callInWindow('cat', 'send', 'custom_goal', {
  goalId: data.goalId
});
...
Created on 20/01/2021, 13:07:29
